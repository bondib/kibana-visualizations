define(function (require) {
    ...
    module.directive('angucomplete', function ($parse, $http, $sce, $timeout) {
        return {
            restrict: 'EA',
            scope: {
                "id": "@id",
            ...
            link: function($scope, elem) {
                ...
                $scope.processResults = function(responseData, str) {
                    ...
                    if (responseData && responseData.length > 0) {
                        ...
                        // Limit the results on the suggestion combobox.
                        var resultsLimit = 9;
                        responseData = responseData.slice(0, resultsLimit);
                ...
                $scope.searchTimerComplete = function(str) {
                    ...
                    if ($scope.searchFunction) {
                        ...
                        $scope.searchFunction().then(function(searchResults) {
                            $scope.processResults(searchResults, str);
                        }).finally(function() {
                            $scope.searching = false;
                        });
                    }
                    else if ($scope.localData) {
